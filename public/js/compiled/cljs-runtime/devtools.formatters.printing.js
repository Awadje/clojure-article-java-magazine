...
var len__4771__auto___27327 = arguments.length;
var i__4772__auto___27328 = (0);
while(true){
if((i__4772__auto___27328 < len__4771__auto___27327)){
args__4777__auto__.push((arguments[i__4772__auto___27328]));

var G__27329 = (i__4772__auto___27328 + (1));
i__4772__auto___27328 = G__27329;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq27295){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27296,G__27297,seq27295__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__27304_SHARP_){
return (!((cljs.core.meta(p1__27304_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27311__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e27314){var _e__26146__auto__ = e27314;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e27316){var _e__26146__auto__ = e27316;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__27318 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__27319 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__27319);

try{var map__27320 = opts;
var map__27320__$1 = cljs.core.__destructure_map(map__27320);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27320__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__27318);
}});
...
var temp__5733__auto___27377 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___27377)){
var managed_print_level_27379 = temp__5733__auto___27377;
var _STAR_print_level_STAR__orig_val__27322_27380 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__27323_27381 = managed_print_level_27379;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__27323_27381);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__27321_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__27321_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__27322_27380);
}} else {
job_fn();
}
