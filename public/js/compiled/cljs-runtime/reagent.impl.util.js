...
var vec__36433 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__36435;
var parts = seq__36434__$1;
...
var self__ = this;
var self__ = this;
var G__36447 = (arguments.length - (1));
switch (G__36447) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args36446){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args36446)));
}));
...
var _STAR_always_update_STAR__orig_val__36505 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__36506 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__36506);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__36505);
}} else {
