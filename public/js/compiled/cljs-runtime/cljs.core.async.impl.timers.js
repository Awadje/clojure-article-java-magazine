...
var i_31998 = (0);
while(true){
if((i_31998 < arr.length)){
(arr[i_31998] = null);

var G__31999 = (i_31998 + (1));
i_31998 = G__31999;
continue;
} else {
}
...
var i_32031 = (self__.level + (1));
while(true){
if((i_32031 <= (new_level + (1)))){
(update[i_32031] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32036 = (update[i]).forward;
(x__$2.forward[i] = (links_32036[i]));
...
var i_32051 = (0);
while(true){
if((i_32051 <= self__.level)){
var links_32053 = (update[i_32051]).forward;
if((x__$1 === (((i_32051 < links_32053.length))?(links_32053[i_32051]):null))){
(links_32053[i_32051] = (x__$1.forward[i_32051]));

var G__32054 = (i_32051 + (1));
i_32051 = G__32054;
continue;
} else {
var G__32055 = (i_32051 + (1));
i_32051 = G__32055;
continue;
}
} else {
...
if(cljs.core.truth_(nx)){
var G__32093 = nx;
var G__32094 = (level__$1 - (1));
x = G__32093;
level__$1 = G__32094;
continue;
} else {
var G__32095 = x;
var G__32096 = (level__$1 - (1));
x = G__32095;
level__$1 = G__32096;
continue;
}
