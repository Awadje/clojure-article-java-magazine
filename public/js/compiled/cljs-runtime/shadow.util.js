...
var len__4771__auto___31752 = arguments.length;
var i__4772__auto___31753 = (0);
while(true){
if((i__4772__auto___31753 < len__4771__auto___31752)){
args_arr__4792__auto__.push((arguments[i__4772__auto___31753]));

var G__31755 = (i__4772__auto___31753 + (1));
i__4772__auto___31753 = G__31755;
continue;
} else {
}
break;
...
/** @this {Function} */
(shadow.util.log.cljs$lang$applyTo = (function (seq31696){
...
var G__31699 = cljs.core.first(seq31696__$2);
var seq31696__$3 = cljs.core.next(seq31696__$2);
var G__31700 = cljs.core.first(seq31696__$3);
var seq31696__$4 = cljs.core.next(seq31696__$3);
var G__31701 = cljs.core.first(seq31696__$4);
var seq31696__$5 = cljs.core.next(seq31696__$4);
var G__31702 = cljs.core.first(seq31696__$5);
var seq31696__$6 = cljs.core.next(seq31696__$5);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31697,G__31698,G__31699,G__31700,G__31701,G__31702,seq31696__$6);
}));

(shadow.util.log.cljs$lang$maxFixedArity = (6));

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__31736){
var vec__31737 = p__31736;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31737,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31737,(1),null);
