...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_29012 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_29012(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_29013 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_29013(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29016 = (function (reader,ch){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_29016(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29020 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_29020(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29025 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_29025(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29029 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_29029(reader);
}
});
...
var G__29091 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__29092 = s.append(c);
c = G__29091;
s = G__29092;
continue;
}
